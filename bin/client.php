...
// class. call() turns any object into its payload, so the call site stays
// typed without the client having to know how the worker deserializes it.
...
$response = $client->call('calculate', new Operands(a: 10, b: 20));
